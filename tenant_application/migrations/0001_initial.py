    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_request', models.CharField(blank=True, default='', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_type', models.CharField(blank=True, choices=[('Drivers License', 'Drivers License'), ('Passport', 'Passport'), ('Other', 'Other')], default='', max_length=20)),
                ('identification_number', models.CharField(blank=True, default='', max_length=40)),
                ('vehicle_registration', models.CharField(blank=True, max_length=10)),
                ('vehicle_make_and_model', models.CharField(blank=True, default='', max_length=80)),
