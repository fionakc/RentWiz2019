    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tenancy_services_id', models.CharField(blank=True, default='', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_number', models.CharField(blank=True, default='', max_length=4)),
                ('house_number', models.CharField(blank=True, default='', max_length=4)),
                ('building_name', models.CharField(blank=True, default='', max_length=80)),
                ...
                ('dwelling_type', models.CharField(blank=True, choices=[('House/Townhouse', 'House/Townhouse'), ('Apartment', 'Apartment'), ('Room', 'Room'), ('Boarding house room', 'Boarding house room'), ('Bedsit/Flat', 'Bedsit/Flat')], default='', max_length=20)),
                ('description', models.TextField(blank=True, default='')),
                ('has_unit_title', models.BooleanField(default=False)),
                ('property_picture', models.ImageField(blank=True, default='', upload_to='')),
                ('school_zone', models.CharField(blank=True, default='', max_length=80)),
